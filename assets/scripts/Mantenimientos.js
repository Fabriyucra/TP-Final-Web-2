var Mantenimientos = function () {
    ...
    function btnMantenimientoNuevo() {
        $('#btn-nuevo-mantenimiento').on('click', function(e) {
            ...
            $.ajax({
                ...
                error: function() {
                    swal({
                        title: 'Ocurrió un error al agregar Servicio',
                        type: 'error'
                    });
                }
            }).done(function(){
    ...
    function eliminarMantenimientoPorId(id) {
        ...
        $.ajax({
            ...
            cargarMantenimientosLista(); // Se vuelve a cargar la lista luego de confirmar borrar Servicio
        });
    } 
    ...
    function btnMantenimientoEditar(id) {
        ...
        $.ajax({
            ...
            success: function(data) {
                swal({
                    title: 'Servicio marcado realizado con éxito',
                    type: 'success'
                });
            },
            error: function() {
    ...
    function btnDatosMantenimiento() {
        // Se carga evento boton ver Servicio
