    ...
    <li class="list-group-item avatar">
		<div class="media">
			...
			<div class="media-right">
				...
				<!-- Editar -->
				<a href="#modalEditarEmpleado" data-id="<?php echo $empleado["ID"]; ?>" class="btn-editar-lista w3-margin-top btn w3-black btn-empleado-editar tooltipped" data-placement="left" title="Editar" data-toggle="modal" data-target="#modalEditarEmpleado">
